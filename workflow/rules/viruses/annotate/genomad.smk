rule viruses__annotate__genomad:
    ...
    output:
        plasmid=VIR_GENOMADA / "mmseqs.rep_seq_plasmid.fna.gz",
        plasmid_genes=VIR_GENOMADA / "mmseqs.rep_seq_plasmid_genes.tsv.gz",
        plasmid_proteins=VIR_GENOMADA / "mmseqs.rep_seq_plasmid_proteins.faa.gz",
        plasmid_summary=VIR_GENOMADA / "mmseqs.rep_seq_plasmid_summary.tsv.gz",
        json=VIR_GENOMADA / "mmseqs.rep_seq_summary.json.gz",
        virus=VIR_GENOMADA / "mmseqs.rep_seq_virus.fna.gz",
        virus_genes=VIR_GENOMADA / "mmseqs.rep_seq_virus_genes.tsv.gz",
        virus_proteins=VIR_GENOMADA / "mmseqs.rep_seq_virus_proteins.faa.gz",
