...
option_list = list(
	make_option(
		...
		type="character",
		default=NULL,
		help="Tab-separated input file with three columns: bin, contig, set; no header!",
		metavar="character"
	),
	make_option(
		c("--hmm"),
    ...
    make_option(
		...
		type="character",
		default="MAGScoT",
        help="output file name base [default=%default]",
		metavar="character"
	),
	make_option(
		c("-a", "--score_a"),
		type="double",
		default=1,
		help="Scoring parameter a [default=%default]"
	),
	make_option(
		c("-b", "--score_b"),
		type="double",
		default=0.5,
		help="Scoring parameter b [default=%default]"
	),
	make_option(
		c("-c", "--score_c"),
		type="double",
		default=0.5,
		help="Scoring parameter c [default=%default]"
	),
	make_option(
		c("-t", "--threshold"),
		type="double",
		default=0.5,
		help="Scoring minimum completeness threshold [default=%default]"
	),
	make_option(
		c("--score_only"),
		action="store_true",
		dest="score_only",
		help="Only do scoring, no refinement [false]"
	),
	make_option(
		c("--skip_merge_bins"),
		action="store_true",
		dest="skip_merge_bins",
		help="Skip bin merging [false]"
	),
